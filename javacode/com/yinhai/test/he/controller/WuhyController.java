...
import  com.yinhai.test.he.service.impl.wuhyService;
...
@Controller
@RequestMapping("/wuhy")
public class WuhyController extends BaseAction{

    @Resource(name = "wuhyService")
    private WuhyService wuhyService;

    /**
     * 页面
     * @return 页面地址
     */
    @RequestMapping("/toWuhyIndex.do")
    public String toExaminationJsp(){
        return "/myjsp/wuhy/index";
    }
